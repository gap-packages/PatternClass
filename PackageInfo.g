...
#
ArchiveURL :=
          "https://github.com/ruthhoffmann/PatternClass/releases/download/2.2/PatternClass2.2",
...
# utilities.",
AbstractHTML :=
  "This package allows basic permutation pattern calculations to \
happen. It especially concentrates on the formation of automata from \
token passing networks and the rank encoding of the output permutation \
of these networks.",

PackageWWWHome := "http://ruthhoffmann.github.io/PatternClass/",
...
#  Archive :=
#          "https://github.com/ruthhoffmann/PatternClass/releases/download/2.2/PatternClass2.2.tar.gz",
...
#    path := DirectoriesPackagePrograms("PatternClass");
...
Keywords := ["permutation patterns", "permutation classes", "pattern classes",
"token passing graphs", "token passing networks","permutation"]
